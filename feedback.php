...
<body>
  ...
  <div class="container-fluid px-0">
    ...
    <div class="section-title">
      <h2>FEEDBACK</h2>
      <span>Feedback your services</span>
  </div>
    ...
    <form class="contact-form" method="post" action="">
      ...
      <input type="text"  name="c3" placeholder="Feedback your words"  required>
...
if(isset($_POST['msg'])){
  ...
  $c4 = $_POST["c4"];
  $c5 =  $_SESSION['email'];
  $sql = "INSERT INTO feedback(cname,emailid,sub,msg,cemail)VALUES ('$c1','$c2','$c3','$c4','$c5')";
