...
<body>
  <div class=" d-flex justify-content-center gap-5 my-3">
    <form id="form1" name="form1" method="post" action="southvegfood.php">
    ...
    <form id="form1" name="form1" method="post" action="southnonvegfood.php">
  ...
  <div class="container">
    <div class="row">
      <?php
      $sql = "SELECT * FROM food where foodtype = 'southindian'";
  ...
  <?php
      ...
      ?>
          <script>
            ...
            window.open("adminsouth.php", "_self");
          </script>
