  ...
  <div class="flex h-screen">
    ...
    <aside class="w-64 bg-blue-900 text-white flex flex-col">
      ...
      <nav class="flex-1 px-4 py-4 space-y-2">
        <a href="#" class="flex items-center gap-3 p-2 rounded hover:bg-blue-700"><span class="material-icons">dashboard</span>Dashboard</a>
        <a href="#"><span class="material-icons">hotel</span> Rooms</a>
        <a href="#"><span class="material-icons">book_online</span> Reservations</a>
        <a href="#"><span class="material-icons">restaurant</span> Food Orders</a>
        <a href="#"><span class="material-icons">reviews</span> Reviews</a>
        <a href="#"><span class="material-icons">groups</span> Customers</a>
        <a href="#"><span class="material-icons">people</span> Staff</a>
        ...
        <a href="#"><span class="material-icons">security</span> Security</a>
        <a href="#" class="hover:bg-red-600 mt-4 p-2 rounded"><span class="material-icons">logout</span> Logout</a>
      </nav>
    </aside>
    ...
    <main class="flex-1 p-6 overflow-y-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white p-5 rounded-xl shadow">
          ...
          <p class="text-2xl font-bold text-blue-900">120</p>
        </div>
        <div class="bg-white p-5 rounded-xl shadow">
