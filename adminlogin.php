    ...
    <div class="login-container">
      ...
      <form action="" method="POST">
        <div class="mb-3">
          ...
          <input  class="form-control" id="email" name="user" placeholder="Enter your username" required />
        </div>
        <div class="mb-3">
...
if(isset($_POST['Login'])){
  $em = $_POST["user"];
  $pw = $_POST["password"];
  $sql = "SELECT * FROM admintable WHERE myadmin = '$em' AND upassword = '$pw'";
