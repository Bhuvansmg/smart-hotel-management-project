...
<body>
  ...
  ?>
      ...
      <form action="" method="post">
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-6">
              <img src="fimages/beverages/<?php echo $row['foodimage']; ?>" width="300" height="40" alt="<?php echo $row['foodname']; ?>" class="product-image">
  ...
  if (isset($_POST['corder'])) {
    ...
    $sql = "insert into custfoodorder(foodname,quantity,foodprice,tablenum)values('$s1','$quantity','$s3','$s4')";
