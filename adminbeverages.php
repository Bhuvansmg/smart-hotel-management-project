        ...
        <div class="col-lg-3 col-md-4 col-sm-8 mb-2 custom-margin">
          <div class="box p-3 text-center">
            ...
            <div class="img-box mb-2" style="border-radius:5px; overflow:hidden;">
              <img src="fimages/beverages/<?php echo $row['foodimage']; ?>" class="img-fluid" style="height:250px; width:250px; object-fit:cover;" alt="Food Image">
            </div>
  ...
  <?php
      ...
      ?>
          <script>
            ...
            window.open("adminbeverages.php", "_self");
          </script>
